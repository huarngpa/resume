...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Amazon}{Seattle, WA}
      {Software Development Engineer II}{Jan 2021 - Present}
      \resumeItemListStart
        \resumeItem{LaunchPad (Monera)}
        ...
        \resumeItem{Discovery}
          {Discovery is a Java, Tomcat, RPC service that serves up over 100,000+ RPS of traffic. It's purpose is to aggregate and cache data from various downstream systems so that internal Amazon customers can query and transform that data (in-app, using our "docket" technology) into a custom product object for their particular business. My contribution to this service is to act as the team's tech lead, responsible for implementing new features (ie. 1:n offers), downstream data sources (ie. collections), and resolve operational issues (ie. resolving media-central service problems).}
      \resumeItemListEnd
