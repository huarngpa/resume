...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{SnowTube}
          {SnowTube is a realtime, streaming service that powers the EC2 core platform by ingesting and distributing EC2 resource (ie. VPC, AMI, etc.) events to other AWS and EC2 services. My role on this project is to develop new features (multi-tenancy), ensure we can meet higher scaling thresholds, improve the codebase and development practices, maintain infrastructure, and drive down the system's operational burden.}
        \resumeItem{Legion}
          {Legion is a Java, Kotlin, Akka service that is intended to replace SnowTube. My role on this project is to design, lead, and implement the migration of legacy (thread-pool based) streaming services onto a clustered, actor system. The goal of this project is to unlock higher reliability, faster development, and faster service-onboarding speeds.}
      \resumeItemListEnd
