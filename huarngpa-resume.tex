...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Software Development Engineer III (EC2)}{Sep 2024 - Present}
      \resumeItemListStart
        \resumeItem{SnowTube}
          {Lead the development of data services for the EC2 core platform. Currently working on AI agents, new streaming capabilities, and scaling the existing data services.}
      \resumeItemListEnd

    \resumeSubheading
      {Amazon Web Services (AWS)}{Seattle, WA}
      {Software Development Engineer II (EC2)}{Oct 2021 - Sep 2024}
      \resumeItemListStart
        \resumeItem{SnowTube}
          {SnowTube is a realtime, streaming service that powers the EC2 core platform by ingesting and distributing EC2 resource (ie. Virts, VPC, AMI, etc.) events to other AWS and EC2 services. I am the tech lead for the team and have been responsible for the following projects: developing custom clustering capabilities, building out new service components for publishing data, improving the codebase and development practices (JDK17, Kotlin, etc.), root-causing and driving down the system's operational burden, and onboarding new users to the system.}
      \resumeItemListEnd
